          ...
          <div className="md:hidden pb-4 border-t border-white/10 mt-2 pt-4">
            {['home', 'services', 'about', 'contact'].map((page) => (
              <button
                key={page}
                onClick={() => navigateTo(page)}
                className={`block w-full text-left px-4 py-3 rounded-lg text-sm font-medium capitalize transition-all ${
                  currentPage === page
            ...
            <button
              onClick={() => navigateTo('contact')}
              className="mt-3 w-full bg-[#3b82f6] hover:bg-blue-600 text-white px-6 py-3 rounded-lg text-sm font-semibold transition-all"
            >
              Book a Session
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md">
              Empowering individuals to achieve mental wellness through evidence-based coaching
              and compassionate support. Your journey to a healthier mind starts here.
            </p>
            <div className="flex space-x-4 mt-6">
              {['M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.